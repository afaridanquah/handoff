...
<div class="pace-activity"></div></div>
        ...
        <div class="l-side-box">
          ...
          <nav class="navigation">
            <ul data-ason-type="menu" class="ason-widget ason-nav">
              ...
              <li class="active"><a href="page-blank.html"><i class="icon fa fa-tachometer"></i><span class="title">Dashboard</span></a></li> 
              ...
              <!-- <li class=""><a href="page-blank.html"><i class="icon fa fa-cogs"></i><span class="title">Account Settings</span></a></li> -->
            </ul>
          </nav>
        </div>
      </aside>
                ...
                <ul class="nav navbar-nav navbar-right">
                  ...
                  <li>
                    ...
                    <div class="widget-profile profile-in-header">
                      <button type="button" data-toggle="dropdown" class="btn dropdown-toggle"><span class="name">{{Auth::user()->name}}</span><i class="fa fa-user" aria-hidden="true"></i></button>
 ...
 <!--    {{Html::script("js/basic/modernizr.min.js")}}
    ...
    <script src="{{ asset('js/calls/part.thedme.setting.js') }}"></script>
